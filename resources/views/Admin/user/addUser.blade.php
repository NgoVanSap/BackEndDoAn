...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <h4 class="font-weight-bold py-3 mb-0">Người dùng</h4>
            ...
            <div class="alert alert-dark-success alert-dismissible fade show"style=" border-radius: 6px;right: 33px; position: absolute; ">
                ...
                <form action="{{ route('add-User') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input name="ngaySinh" value="{{ old('ngaySinh') }}" type="text" class="form-control" placeholder="Ngày sinh">
                            <div class="clearfix"></div>
                            @error('ngaySinh')
                                <span style="color:red">{{ $message }}</span>
                            @enderror
